...
const Header = function () {
  ...
  const NavDynamique = () => {
    ...
    const Logo = () => {
      return (
        <Link
          to="/"
          className=" h-full m-auto flex items-center sm:ml-0  "
          onClick={() => {
            // @ts-ignore
            setPageActive({ home: true });
          }}>
    ...
    const NavConnected = () => {
      ...
      const cssButton =
        '  cursor-pointer w-10  h-10 border-[2px] sm:flex justify-center items-center  rounded-full overflow-hidden ';
      const style = {
        button: cssButton,
      ...
      return (
        <nav className="flex mr-2 ">
          ...
          <button
            className={` hidden sm:w-24 sm:flex items-center justify-between  ${
          ...
          {ClickProfil ? (
            <div className="absolute bg-white w-60 h-28 top-16 right-10 rounded  flex flex-col  shadow-2xl z-10">
              ...
              <button className="bg-white text-tertiary-black h-10 p-2  rounded-sm border-t" onClick={logOut}>
                Déconexion
              </button>
            </div>
          ) : (
  ...
  return (
    ...
    (
      <header
        className={`flex justify-between h-12 shadow-xl pl-1 w-screen ${themeContext.header.fontColor} `}>
        {/* ============================== Nav Header Top ============================== */}
        ...
        <nav
          ...
          <Link
            ...
            onClick={() => {
              // @ts-ignore
              setPageActive({ memessaging: true });
            }}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
          ...
          <Link
            // @ts-ignore
            to={!userContext.userData ? '/login' : './profil/setting'}
            // @ts-ignore
