...
const Header = function () {
  ...
  // const toggleConnect = (param = false) => {
  ...
  //     };
  //     const cssButton =
  //       ' m-auto cursor-pointer w-10  h-10 border-[2px] flex justify-center items-center  rounded-full overflow-hidden ';
  //     const style = {
  //       button: cssButton,
  //       buttonPush:
  //         cssButton + 'border-primary-red text-secondary-pink shadow-xl border-[4.01px]',
  //       // hover:[shadow-xl, p-1.5, border-[4px]]
  //       buttonHover:
  //         'hover:border-[3px] hover:shadow-xl  hover:border-secondary-pink hover:text-secondary-pink ',
  //       iconButton: 'p-1',
  //     };
  //     return (
  //       <>
  //         <script
  //           src='https://kit.fontawesome.com/11d72bfdc7.js'
  ...
  //             </div>
  //             <button
  //               className='bg-white text-tertiary-black h-10  rounded-sm'
  //               onClick={logOut}
  //             >
  //               Déconexion
  //             </button>
    ...
    (
      ...
      <header className='flex justify-center h-14 shadow-xl pl-4 w-full  bg-tertiary-black     text-white sm:'>
        ...
        <nav className='absolute bottom-0 left-0 bg-tertiary-black  w-full h-12 flex items-center justify-around sm:hidden  '>
          <Link
            to={!userIsConnected ? '/login' : './notifs'}
            className={` h-14 flex items-center justify-start  sm:hidden`}
          >
          ...
          <Link
            to={!userIsConnected ? '/login' : '/post/create'}
            className={`${class_buttonMobile} rounded-full bg-white`}
          >
            <FontAwesomeIcon
              className='text-tertiary-black h-8'
              icon={faPlus}
              height='90%'
            />
          </Link>

          <Link to={!userIsConnected ? '/login' : '/profil?id=' + userIsConnected.id}>
            <div className={`${class_buttonMobile}`}>
              <FontAwesomeIcon icon={faUser} height='60%' />
            </div>
          </Link>
          <Link
            to={!userIsConnected ? '/login' : './profil/setting'}
            className={` h-14 flex items-center justify-start  sm:hidden`}
          >
